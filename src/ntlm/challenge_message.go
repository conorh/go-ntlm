...
// See MS-NLMP - 2.2.1.2
// The CHALLENGE_MESSAGE defines an NTLM challenge message that is sent from the
// server to the client. The CHALLENGE_MESSAGE is used by the server to challenge
// the client to prove its identity. For connection-oriented requests, the
// CHALLENGE_MESSAGE generated by the server is in response to the
